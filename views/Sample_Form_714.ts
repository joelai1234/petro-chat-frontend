...
**/     
  ...
  <body><div style="display:none"><ix:header><ix:hidden></ix:hidden><ix:references></ix:references><ix:resources></ix:resources></ix:header></div><div class="xbrl">
    <table class="schedule-header xbrl" width="100%">
        <tr>
            <td class="form-name-top">
                <div class="ferc-seal"></div>
                Federal Energy Regulatory Commission<br/>
                FERC Form No. 714
            </td>
            <td>
                <div class="sch-header-title">
                    Annual Electric Balancing Authority Area and Planning <br/>Area Report
                </div>
                <br/>
                <div class="sch-as-of-date-title">For the Year Ending December 31,
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
            <td class="xbrl form-id-code-top"></td>
        </tr>
    </table>
    <table class="xbrl" width="100%">
        <tr class="sch-title">
            <td class="xbrl" colspan="4">
                <div class="sub-value sub-replacement">Part I - Schedule 1. Identification and Certification</div></td>
        </tr>
        <tr>
            <td colspan="4"></td>
        </tr>
        <tr>
            <td class="left-id-col split-page" style="padding-bottom: 20px" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2"></td>
        </tr>
        <tr>
            <td class="col-heading-row left-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement"><div class="sub-html">1. Respondent Identification:</div></div></td>
            <td class="col-heading-row right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement"><div class="sub-html">3. Respondent Mailing Address:</div></div></td>
        </tr>
        <tr>
        <td class="left-id-col split-page" style="padding-bottom: 20px" colspan="2"></td>
        <td class="right-id-col split-page" colspan="2"></td>
        ...
        <tr>
            <td class="right-id-col quart-split">
                <div class="sub-value sub-replacement">Code:</div><%= respondent_identification_code %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
            <td class="left-id-col quart-split">
                <div class="sub-value sub-replacement">Name:</div><%= respondent_name %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>

            <td class="right-id-col split-page" colspan="2">
                <div class="sub-value sub-no-replacement"><%= mailing_address %></div></td>
        </tr>
        <tr>
            <td class="left-id-col split-page" style="padding-bottom: 60px" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2"></td>
        </tr>
        <tr>
            <td class="col-heading-row left-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">2. Respondent Type: (Please check appropriate box and fill in name)</div></td>
            <td class="right-id-col split-page" colspan="2"></td>
        ...
        <tr>
            <td class="left-id-col split-page" colspan="2">
                
                        <div class="sub-value sub-replacement"><div class="sub-html"><span class="checkbox">&#9745;</span> Part I: Balancing Authority Area (Complete Parts I, II, and IV)</div></div></td>

            <td class="col-heading-row right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">4. Contact Person:</div></td>
        </tr>
        <tr>
            <td class="left-id-col split-page" style="padding-bottom: 10px" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2"></td>
        </tr>
        <tr>
            <td class="left-id-col2 split-page" colspan="2">
                    
                <div class="sub-value sub-replacement"><div class="sub-html"><span class="checkbox">&#9744;</span> Unit dispatch is not based on the economic dispatch of thermal units (i.e., a system lambda is not calculated)</div></div></td>
            <td class="right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">Name:</div><%= contact_name %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="left-id-col split-page" colspan="2">
                <div> Balancing Authority Area Name:
                    
                </div>
            </td>
            <td class="right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">Title:</div><%= contact_title %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
        </tr>
        <tr>
            <td class="left-id-col2 split-page" style="padding-bottom: 60px" colspan="2">
        ...
        <tr>
            <td class="left-id-col split-page" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">E-mail address:</div><%= contact_email_address %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="left-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement"><div class="sub-html"><span class="checkbox">&#9744;</span> Part II: Planning Area (Complete Parts I, III, and IV)</div></div></td>
            <td class="right-id-col quart-split">
                <div class="sub-value sub-replacement">Telephone #:<%= contact_telephone_number %></div><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
            <td class="right-id-col quart-split">
                <div class="sub-value sub-replacement">Ext:</div><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="left-id-col2 split-page" style="padding-bottom: 40px" colspan="2">
                <div class="sub-value sub-no-replacement"></div></td>
            <td class="right-id-col" colspan="2"></td>
        </tr>
        
        <tr>
            <td class="left-id-col" colspan="2">    
            </td>
            <td class="col-heading-row right-id-col" colspan="2">
                <div class="sub-value sub-replacement">5. Certifying Official:</div></td>
        </tr>
        <tr>
            <td class="left-id-col split-page" style="padding-bottom: 10px" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2"></td>
        ...
        <tr>
            <td class="left-id-col split-page" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">Name:</div><%= certifying_official_name %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="left-id-col split-page" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">Title:</div><%= certifying_official_title %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="left-id-col split-page" colspan="2"></td>
            <td class="right-id-col split-page" colspan="2">
                <div class="sub-value sub-replacement">Date:</div><%= certifying_official_date %><div>
                    <div class="sub-value sub-no-replacement"></div></div>
            </td>
        </tr>
   ...
   <table class="xbrl" width="100%">
         <tr>
            <td class="left-id-col" colspan="4">
                <div class="sub-value sub-replacement">This report is an</div><div class="sub-value sub-replacement"><div class="sub-html"><span class="checkbox">&#9745;</span> Original</div></div><div class="sub-value sub-replacement"><div class="sub-html"><span class="checkbox">&#9744;</span> Revised Filing</div></div></td>
        </tr>
        <tr>
            <td class="split-page" style="padding-bottom: 50px" colspan="4"></td>
        ...
        <tr>
            <td class="split-page" style="padding-bottom: 150px" colspan="4"></td>
...
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
                <tr>
                    <td class="form-name-top">Federal Energy Regulatory Commission<br/>
                        FERC Form No. 714
                    </td>
                    <td>
                        <div class="sch-header-title">
    ...
    <table class="xbrl">
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">PlantName</div></div>    
                        <div class="sub-value sub-replacement">Plant Name</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">PlantAvailableCapacityAtTheHourOfTheAnnualPeakDemandOnNetEnergyForLoad</div></div>    
                        <div class="sub-value sub-replacement">Plant Available Capacity at the Hour of the Annual Peak Demand on Net Energy for Load (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">IntegratedNetLoadOnThePlantAtTheHourOfTheAnnualPeakDemandBasedOnNetEnergyForLoad</div></div>    
                        <div class="sub-value sub-replacement">Integrated Net Load on the Plant at the Hour of the Annual Peak Demand Based on Net Energy for Load (MW)</div></div>
                </div>
            ...
            <tr class="schedule-row">
                ...
                <td class="description_items xbrl"><div class="sub-value sub-no-replacement">Keystone Generating</div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div>1733</td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div>1500</td>
            ...
            <tr class="schedule-row">
                ...
                <td class="xbrl description_items"><div class="sub-value sub-no-replacement"></div></td>
                <td class="description_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                ...
                <td class="description_items xbrl">TOTAL
                </td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
    ...
    <table class="xbrl">
        <tr class="sch-title">
            <td class="xbrl" colspan="10">
                    <div class="sub-value sub-replacement">Part II - Schedule 2. Balancing Authority Area Monthly Capabilities at Time of Monthly Peak Demand</div></td>
        </tr>
        <tr>
            <td class="instruction xbrl" colspan="10">
                <div class="sub-value sub-replacement"><div class="sub-html"><p>The peak demand and other terms used in this schedule are defined in the Form 714 instructions. Please first read the instructions, then complete this Schedule. The value in column (c) for the month of the annual peak demand should equal the total in column (d) in Schedule 1. Any difference must be explained in a footnote.</p></div></div></td>
        </tr>
        <tr class="col-heading-row">
            <td class="xbrl-no-bottom-line" colspan="1"> </td>
            <td class="xbrl-no-bottom-line" colspan="1"> </td>
            <td class="xbrl center-text" colspan="8">Net Capability at the Time of the Monthly Peak Demand, Based on Balancing Authority Area Area Net Energy For Load (NEL) </td>
        </tr>
        <tr class="col-heading-row">
            <td class="xbrl-no-bottom-top-line" colspan="1"> </td>
            <td class="xbrl-no-bottom-top-line" colspan="1"> </td>
            <td class="xbrl center-text" colspan="5">Net Capability from Plants Reported on Schedule II </td>
            <td class="xbrl center-text" colspan="2">External to the Balancing Authority Area Net Unit or Firm Capability (MW) </td>
            <td colspan="1"> </td>
        </tr>
        <tr class="col-heading-row">
            <td class="xbrl-no-bottom-top-line" colspan="1"> </td>
            <td class="xbrl-no-bottom-top-line" colspan="1"> </td>
            <td class="xbrl-no-bottom-line" colspan="1"> </td>
            <td class="xbrl center-text" colspan="3">Unavailable Capability Due to: </td>
            <td class="xbrl-no-bottom-line center-text" colspan="1"></td>
            <td class="xbrl-no-bottom-line center-text" colspan="1"></td>
            <td class="xbrl-no-bottom-line center-text" colspan="1"></td>
            <td colspan="1"> </td>
        </tr>
        <tr class="col-heading-row">
            <td class="col-heading xbrl-no-top-line line-number"><div>Line No.</div><div>(a)</div></td>
            <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">MonthAxis</div></div>    
                        <div class="sub-value sub-replacement">Month</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">PlantsAvailableCapability</div></div>    
                        <div class="sub-value sub-replacement">Available Capability (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">UnavailableCapabilityDueToPlannedOutageAndDerating</div></div>    
                        <div class="sub-value sub-replacement">Planned Outage and Derating (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">UnavailableCapabilityDueToUnplannedOutageAndDerating</div></div>    
                        <div class="sub-value sub-replacement">Unplanned Outage and Derating (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">UnavailableCapabilityDueToOtherOutageAndDerating</div></div>    
                        <div class="sub-value sub-replacement">Other Outage and Derating (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NetCapabilityFromPlants</div></div>    
                        <div class="sub-value sub-replacement">Total (c + d + e + f) (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ExternalToTheBalancingAuthorityAreaNetUnitOrFirmCapabilityAvailable</div></div>    
                        <div class="sub-value sub-replacement">Available (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ExternalToTheBalancingAuthorityAreaNetUnitOrFirmCapabilityNotAvailable</div></div>    
                        <div class="sub-value sub-replacement">Not Available (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NetCapabilityAtTheTimeOfTheMonthlyPeakDemand</div></div>    
                        <div class="sub-value sub-replacement">Total Capability (g + h + i) (MW)</div></div>
                </div>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">1</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Jan</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">7042</div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">300</div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">200</div></td>

                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">100</div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">200</div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">100</div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">200</div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement">100</div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">2</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Feb</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">3</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Mar</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">4</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Apr</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">5</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">May</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">6</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Jun</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">7</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Jul</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">8</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Aug</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">9</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Sep</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">10</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Oct</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">11</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Nov</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">12</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">Dec</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">3</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
    ...
    <table class="xbrl">
        ...
        <tr class="col-heading-row">
            ...
            <td class="xbrl-no-bottom-line" colspan="1"> </td>
            <td class="xbrl-no-bottom-line" colspan="1"> </td>
            <td class="xbrl col-heading" colspan="5">Balancing Authority Area Area Load Sources at Time of Balancing Authority Area Area Monthly Peak Demand, Based on Net Energy For Load (NEL)</td>
            <td class="xbrl-no-bottom-line" colspan="1"> </td>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NetEnergyForLoadAndPeakDemandSourcesByMonthBalancingAuthorityAreaNetGeneration</div></div>    
                        <div class="sub-value sub-replacement">Balancing Authority Area Net Generation (MWh)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NetEnergyForLoadAndPeakDemandSourcesByMonthNetActualInterchange</div></div>    
                        <div class="sub-value sub-replacement">Net Actual Interchange (MWh)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NetEnergyForLoadAndPeakDemandSourcesByMonthNetEnergyForLoad</div></div>    
                        <div class="sub-value sub-replacement">Net Energy for Load (MWh) (c + d)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">LoadSourcesAtTimeOfBalancingAuthorityAreaMonthlyPeakDemandOutputOfGeneratingPlants</div></div>    
                        <div class="sub-value sub-replacement">Output of Generating Plants (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">LoadSourcesAtTimeOfBalancingAuthorityAreaMonthlyPeakDemandUnitOrFirmPurchases</div></div>    
                        <div class="sub-value sub-replacement">Unit or Firm Purchases (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">LoadSourcesAtTimeOfBalancingAuthorityAreaMonthlyPeakDemandUnitOrFirmSales</div></div>    
                        <div class="sub-value sub-replacement">Unit or Firm Sales (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">LoadSourcesAtTimeOfBalancingAuthorityAreaMonthlyPeakDemandNetNonFirmAndInadvertent</div></div>    
                        <div class="sub-value sub-replacement">Net Non-Firm &amp; Inadvertent (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">LoadSourcesAtTimeOfBalancingAuthorityAreaMonthlyPeakDemandMonthlyPeakDemand</div></div>    
                        <div class="sub-value sub-replacement">Monthly Peak Demand (MW) (f + g + h - i)</div></div>
                </div>
        ...
        <td class="col-heading xbrl-no-top-line">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NetEnergyForLoadAndPeakDemandSourcesByMonthMonthlyMinimumDemand</div></div>    
                        <div class="sub-value sub-replacement">Monthly Minimum Demand (MW)</div></div>
                </div>

                <div style="text-align: center"><div class="sub-value sub-replacement">(k)</div></div>
            </td>
        
        </tr>
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">1</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">January</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">2</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">February</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">3</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">March</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">4</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">April</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">6</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">June</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">7</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">July</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">8</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">August</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">9</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">September</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">10</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">October</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">11</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">November</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
            ...
            <tr class="schedule-row">
                <td class="xbrl line-number"><span class="sub-line-number">12</span></td>
                <td class="xbrl short_months"><div class="sub-value sub-replacement">December</div></td>
               <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
                <td class="numeric_items xbrl"><div class="sub-value sub-no-replacement"></div></td>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">4</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
    ...
    <table class="xbrl">
        ...
        <tr class="col-heading-row">
            ...
            <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NameOfAdjacentBalancingAuthorityArea</div></div>    
                        <div class="sub-value sub-replacement">Name of Adjacent Balancing Authority Area</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">BalancingAuthorityAreaInterconnectionLineOrBusNames</div></div>    
                        <div class="sub-value sub-replacement">Balancing Authority Area Interconnection Line or Bus Names</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">LineOrBusVoltage</div></div>    
                        <div class="sub-value sub-replacement">Line or Bus Voltage (kV)</div></div>
                </div>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">5</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
    ...
    <table class="xbrl">
        <tr class="sch-title">
            <td class="xbrl" colspan="6">
                    <div class="sub-value sub-replacement">Part II - Schedule 5. Balancing Authority Area Scheduled and Actual Interchange</div></td>
        </tr>
        <tr>
            <td class="instruction xbrl" colspan="6">
                <div class="sub-value sub-replacement"><div class="sub-html"><p>Identify on this schedule: each balancing authority area with which the respondent balancing authority area has actual or scheduled interchange of energy, in column (b); the total annual megawatthours (MWh) of the scheduled interchange that were received by the respondent balancing authority area through all interconnection points with each balancing authority area, in column (c); the MWh of scheduled interchange delivered to each balancing authority area, in column (d); the MWh of total annual actual interchange received and delivered within each adjacent balancing authority area, in columns (e) and (f). Provide totals for columns (c), (d), (e) and (f). The difference in the totals for columns (e) minus (f) should equal the total in column (d) on Schedule 3. Any difference must be explained in a footnote. Refer to the Form 714 instructions for specific guidelines.</p></div></div></td>
        ...
        <tr>
            <td colspan="2"></td>
            <td class="xbrl col-heading" colspan="2">Scheduled Interchange Between Balancing Authority Area Areas 
                (MWh)</td>
            <td class="xbrl col-heading" colspan="2">Actual Interchange Between Adjacent Balancing Authority Area Areas
                (MWh)</td>
        </tr>
        <tr class="col-heading-row">
            <td class="col-heading xbrl line-number"><div>Line No.</div><div>(a)</div></td>
            <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">NameOfBalancingAuthorityArea</div></div>    
                        <div class="sub-value sub-replacement">Name of Balancing Authority Area</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ScheduledInterchangeBetweenBalancingAuthorityAreasReceived</div></div>    
                        <div class="sub-value sub-replacement">Received</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ScheduledInterchangeBetweenBalancingAuthorityAreasDelivered</div></div>    
                        <div class="sub-value sub-replacement">Delivered</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ActualInterchangeBetweenAdjacentBalancingAuthorityAreasReceived</div></div>    
                        <div class="sub-value sub-replacement">Received</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ActualInterchangeBetweenAdjacentBalancingAuthorityAreasDelivered</div></div>    
                        <div class="sub-value sub-replacement">Delivered</div></div>
                </div>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">6</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
    ...
    <table class="xbrl">
        <tr class="sch-title">
            <td class="xbrl" colspan="26">
                <div class="sub-value sub-replacement">Part II - Schedule 6. Balancing Authority Area System Lambda Data</div></td>
        </tr>
        <tr>
            <td class="instruction xbrl" colspan="26">
                <div class="sub-value sub-replacement"><div class="sub-html"><p>For balancing authority areas where demand following is primarily performed by thermal generating units, the system lambda is derived from the economic dispatch function associated with automatic generation control performed at the controlling utility or pool control center. Excluding transmission losses, the fuel cost ($/hr) for a set of on-line and loaded thermal generating units (steam and gas turbines) is minimum 1/ when each unit is loaded and operating at the same incremental fuel cost ($/MWh) 2/ with the sum of the unit loadings (MW) equal to the system demand plus the net of interchange with other Balancing Authority Areas. This single incremental cost of energy is the system lambda. System lambdas are likely recalculated many times in one clock hour. However, the indicated system lambda  occurring on each clock hour would be sufficient for reporting purposes. Respondents must provide the following data: the system lambda, in dollars, for each hour of the year starting with 1 a.m. January 1 as more fully described in the Form 714 instructions. In column (b) indicate the time zone and the days for which daylight savings time was observed. This schedule will have 365 rows for the report year (366 rows for a leap year).</p>
<p>Provide, as a footnote, an explanation describing the reason for the unavailability of system lambda information. The Commission expects that all Energy Management Systems, with proper instructions, can record the system lambda being used for economic dispatch of the balancing authority area's thermal units.</p>
<p>Respondents should be able to report system lambda, along with the other information reported on a Balancing Authority Area basis, that describe the operation of such areas from information that should be readily available. The Commission is not requesting Respondents to develop incremental or marginal cost (either short or long term) according to any formula. Nor is the Commission requesting "avoided cost rates" that electric utilities file with state commissions or otherwise make available for prospective qualified facilities.</p></div></div></td>
        </tr>
        
        <tr class="col-heading-row">
            <td class="col-heading xbrl line-number"><div>Date</div><div>(a)</div></td>
            <td class="col-heading xbrl line-number"><div>Time Zone</div><div>(b)</div></td>
            <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0100</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(c)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0200</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(d)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0300</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(e)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0400</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(f)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0500</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(g)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0600</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(h)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0700</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(i)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0800</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(j)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">0900</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(k)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1000</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(l)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1100</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(m)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1200</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(n)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1300</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(o)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1400</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(p)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1500</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(q)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1600</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(r)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1700</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(s)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1800</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(t)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">1900</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(u)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">2000</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(v)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">2100</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(w)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">2200</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(x)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">2300</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(y)</div></div>
            </td>
        <td class="col-heading xbrl">
                <div style="text-align: center">
                     <div class="sub-value sub-replacement">2400</div></div>
                <div style="text-align: center">
                        <div class="sub-value sub-replacement">(z)</div></div>
            </td>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">7a</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
    ...
    <table class="xbrl" width="100%">
        <tr class="sch-title">
            <td class="xbrl">
                <div class="sub-value sub-replacement">Part II - Schedule 6. Description of Economic Dispatch</div></td>
        </tr>
        <tr>
            <td class="instruction xbrl">
                <div class="sub-value sub-replacement"><div class="sub-html">Disclosure of How Respondent Calculates System Lambda</div></div></td>
        </tr>
        <tr class="schedule-row">
            
                <td class="description-items xbrl">
                    <div class="sub-value sub-no-replacement"></div></td>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">7b</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
    ...
    <table class="xbrl">
        <tr class="sch-title">
            <td class="xbrl" colspan="6">
                    <div class="sub-value sub-replacement">Part III - Schedule 1. Electric Utilities That Compose the Planning Area</div></td>
        </tr>
        <tr>
            <td class="instruction xbrl" colspan="6">
                <div class="sub-value sub-replacement"><div class="sub-html"><p>Enter the name of each entity, including the respondent, that forms the planning area for which this report is being prepared and their coincident summer and winter peak demands in megawatts. Refer to the Form 714 instructions for specific guidelines.</p></div></div></td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td class="xbrl col-heading" colspan="2">Electric Utility Coincident Peak Demand
                    (MW)
                (MWh)</td>
        </tr>
        <tr class="col-heading-row">
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ElectricUtilityCoincidentPeakDemandSummer</div></div>    
                        <div class="sub-value sub-replacement">Summer</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">ElectricUtilityCoincidentPeakDemandWinter</div></div>    
                        <div class="sub-value sub-replacement">Winter</div></div>
                </div>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">8</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
        <table class="schedule-header xbrl" width="100%">
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">9a</div></div> 
</div>
</div>
<hr class="screen-page-separator schedule-separator"></hr><div class="print-page-separator sechedule-separator"></div><div class="xbrl">
    <table class="schedule-header xbrl" width="100%">
    ...
    <table class="xbrl">
        <tr class="sch-title">
            <td class="xbrl" colspan="6">
                    <div class="sub-value sub-replacement">Part III - Schedule 2. Forecast Summer and Winter Peak Demand and Annual Net Energy for Load</div></td>
        </tr>
        <tr>
            <td class="instruction xbrl" colspan="6">
                <div class="sub-value sub-replacement"><div class="sub-html"><p>Provide the planning area's forecast summer and winter peak demand, in megawatts, and annual net energy for load, in megawatthours, for the next ten years.</p></div></div></td>
        </tr>
        <tr class="col-heading-row">
            <td class="col-heading xbrl line-number"><div>Line No.</div><div>(a)</div></td>
            <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">PlanningAreaHourlyDemandAndForecastYear</div></div>    
                        <div class="sub-value sub-replacement">Year</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">PlanningAreaHourlyDemandAndForecastSummerForecast</div></div>    
                        <div class="sub-value sub-replacement">Summer Forecast (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">PlanningAreaHourlyDemandAndForecastWinterForecast</div></div>    
                        <div class="sub-value sub-replacement">Winter Forecast (MW)</div></div>
                </div>
        ...
        <td class="col-heading xbrl">
                <div style="text-align: center">
                    <div class="tooltip">
                            <div class="tooltiptext">
                                    <div class="sub-value sub-replacement">PlanningAreaHourlyDemandAndForecastForecastOfAnnualNetEnergyForLoad</div></div>    
                        <div class="sub-value sub-replacement">Forecast of Annual Net Energy for Load (MWh)</div></div>
                </div>
...
<div class="schedule-footer">
        <div class="center-text">Page 
                <div class="sub-value sub-replacement">9b</div></div> 
</div>
</div>
</body>
</html>`
